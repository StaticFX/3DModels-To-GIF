...
class STLRenderer {
    ...
    renderImage() {
        ...
        const imgData = new Uint8Array(gl.drawingBufferWidth * gl.drawingBufferHeight * 4);
        gl.readPixels(0, 0, gl.drawingBufferWidth, gl.drawingBufferHeight, gl.RGBA, gl.UNSIGNED_BYTE, imgData);
        return imgData;
    }
    ...
    async #loadMesh() {
        ...
        const camera = new THREE.PerspectiveCamera(75, this.width / this.height, 1, 20000);
